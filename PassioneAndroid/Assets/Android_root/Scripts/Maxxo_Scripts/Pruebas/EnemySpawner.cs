...
public class EnemySpawner : MonoBehaviour
{
    ...
    public void SpawnEnemies()
    {
        if (spawn1 == true)
        {
            ...
            Instantiate(enemy1, new Vector3(transform.position.x, enemy1.transform.position.y), enemy1.transform.rotation); Debug.Log("1");
        ...
        if (spawn2 == true)
        {
            ...
            Instantiate(enemy2, new Vector3(transform.position.x, enemy2.transform.position.y), enemy2.transform.rotation); Debug.Log("2");
        ...
        if (spawn3 == true)
        {
            ...
            Instantiate(enemy3, new Vector3(transform.position.x, enemy3.transform.position.y), enemy3.transform.rotation); Debug.Log("3");
